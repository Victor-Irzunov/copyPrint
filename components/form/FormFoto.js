...
export const FormFoto = ({ handleCancel, title, }) => {
	...
	const onFinish = async (values) => {
		...
		formData.append("count", countValue ? countValue : '1')
		...
		formData.append("sposob", values.sposob ? values.sposob : '-')
		formData.append("vid", values.vid ? values.vid : '-')
		...
		<div className='overflow-hidden	overflow-x-hidden'>
			...
			>
				...
				>
					<Radio.Group>
						<Space direction="vertical">
							<Radio value='Epson'>Epson</Radio>
							<Radio value='Fujifilm'>Fujifilm</Radio>
						</Space>
					</Radio.Group>
				</Form.Item>
				<Form.Item
				...
				>
					<Radio.Group>
						<Space direction="vertical">
							<Radio value='9х13'>9х13</Radio>
							<Radio value='10х15'>10х15</Radio>
							<Radio value='13х18'>13х18</Radio>
							<Radio value='15х21'>15х21</Radio>
							<Radio value='20х30'>20х30</Radio>
							<Radio value='30х40'>30х40</Radio>
						</Space>
					</Radio.Group>
				</Form.Item>	
				<Form.Item
				...
				>
					<Radio.Group>
						<Space direction="vertical">
							<Radio value='матовая'>Матовая</Radio>
							<Radio value='глянцевая'>Глянцевая</Radio>
						</Space>
					</Radio.Group>
				</Form.Item>
				<Form.Item
