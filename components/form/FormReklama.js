...
export const FormReklama = ({ handleCancel, title, }) => {
		...
		<div className='overflow-hidden	overflow-x-hidden'>
			...
			>
				...
				>
					<Radio.Group>
						<Space direction="vertical">
							<Radio value='1-сторонний'>1-сторонний</Radio>
							<Radio value='2-х сторонний'>2-х сторонний</Radio>
						</Space>
					</Radio.Group>
				</Form.Item>
				<Form.Item
